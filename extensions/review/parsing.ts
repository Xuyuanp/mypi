/**
 * Markdown parsing and review finding detection utilities.
 *
 * Pure functions for parsing review output -- extracting headings,
 * identifying findings sections, and determining whether a review
...
export function getFindingsSectionBounds(
    lines: string[],
